...
class ProducerConsumerRandomSuite : public testing::TestWithParam<size_t>
{
};

TEST_P(ProducerConsumerRandomSuite, RandomTest)
{
...
INSTANTIATE_TEST_SUITE_P(ProducerConsumer, ProducerConsumerRandomSuite, testing::ValuesIn(random_vector_size));